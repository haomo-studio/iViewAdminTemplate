...
config.output.publicPath = 'http://skillee.haomo-studio.com/dist/'; // 资源路径,根据需要可改为cdn地址
...
// 提取带hash值的第三方库名称
new webpack.optimize.CommonsChunkPlugin('vendors', 'vendors.[hash].js'), new webpack.DefinePlugin({
    'process.env': {
        NODE_ENV: '"production"'
    }
}),
