...
<script>
   let splitData = function(rawData) {
    var categoryData = [];
    var values = [];
  ...
  export default {
    data () {
      return {
        lineChart: null,
        barChart: null,
        evaporation:[10, 30, 20, 40, 50, 70, 60, 80, 60, 70, 50, 30],
        precipitation:[30, 20, 40, 50, 70, 60, 80, 60, 70, 50, 30, 10],
        data0: splitData([
    ...
    methods: {
      ...
      klineOption(id){
        this.klineChart = echarts.init(document.getElementById(id));
    ...
    created () {
      this.$nextTick(function () {
        this.lineOption('lineChart');
        this.barOption('barChart');
        this.pieOption('pieChart');
        this.radarOption('radarChart');
        this.klineOption('klineChart');
